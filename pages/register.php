    ...
    <div class="container">
        <div class="card shadow rounded-3 my-5 bg-white border-0 p-5">
            ...
            <form action="" method="post">
                ...
                <div class="row mt-3">
                    <div class="col">
                        <label for="exampleFormControlInput1" class="form-label">Institusi <span style="color: red;">*</span></label>
                        <input type="text" name="institusi" class="form-control" id="exampleFormControlInput1" placeholder="">
                    </div>
                    <div class="col">
                        <label for="exampleFormControlInput1" class="form-label">Birth Date <span style="color: red;">*</span></label>
                        <input type="date" name="dob" class="form-control" id="exampleFormControlInput1" placeholder="">
                    </div>
                </div>
                <div class="row mt-3 mb-5">
                    <div class="col">
                        <label for="exampleFormControlInput1" class="form-label">Jenjang Pendidikan <span style="color: red;">*</span></label>
                    ...
                    <div class="col">
                        <label for="exampleFormControlInput1" class="form-label">No. WA <span style="color: red;">*</span></label>
                        <input type="text" name="no_wa" class="form-control" id="exampleFormControlInput1" placeholder="">
                    </div>
                </div>
                <button type="submit" name="btnSubmit" class="btn" style="background-color: #D61C4E; color: white; width: 100%;">Register</button>
