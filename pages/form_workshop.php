    ...
    <div class="container">
        <div class="card shadow rounded-3 my-5 bg-white border-0 p-5">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Nama Workshop <span style="color: red;">*</span></label>
                    <input type="text" name="nama_workshop" value="<?= $objWorkshop->nama_workshop ?>" class="form-control" id="exampleFormControlInput1" placeholder="">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Kategori <span style="color: red;">*</span></label>
                ...
                <div class="mb-3">
                    <label for="formFile" class="form-label">Gambar Flyer Workshop <span style="color: red;">*</span></label>
                    <input class="form-control" type="file" name="fupload" value="<?= $objWorkshop->gambar ?>" id="formFile">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Deskripsi <span style="color: red;">*</span></label>
                    <textarea name="des_workshop" class="form-control" id="exampleFormControlTextarea1" rows="3"><?= $objWorkshop->deskripsi ?></textarea>
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlTextarea2" class="form-label">Benefit <span style="color: red;">*</span></label>
                    <textarea name="benefit_workshop" class="form-control" id="exampleFormControlTextarea2" rows="3"><?= $objWorkshop->benefit ?></textarea>
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Tanggal Pelaksanaan <span style="color: red;">*</span></label>
                    <input type="date" name="tgl" value="<?= $objWorkshop->tanggal_pelaksanaan ?>" class="form-control" id="exampleFormControlInput1" placeholder="">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Waktu Pelaksanaan <span style="color: red;">*</span></label>
                    <input type="text" name="waktu" value="<?= $objWorkshop->waktu ?>" class="form-control" id="exampleFormControlInput1" placeholder="">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Tempat Pelaksanaan <span style="color: red;">*</span></label>
                    <input type="text" name="tempat" value="<?= $objWorkshop->tempat_pelaksanaan ?>" class="form-control" id="exampleFormControlInput1" placeholder="">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Provinsi <span style="color: red;">*</span></label>
                ...
                <button type="submit" name="btnSubmit" class="btn" style="background-color: #D61C4E; color: white; width: 100%;">Simpan</button>
