        ...
        <form class="mt-5" action="" method="post">
            <?php
                if (!isset($_SESSION['level']) || $_SESSION['level'] == 'admin') {
                    echo '<button type="button" class="btn" disabled style="background-color: #D61C4E; color: white; width: 100%;">Daftar Sekarang!</button>';
                } else {
                    echo '<button type="submit" name="btnSubmit" class="btn" style="background-color: #D61C4E; color: white; width: 100%;">Daftar Sekarang!</button>';
                }
            ?>
