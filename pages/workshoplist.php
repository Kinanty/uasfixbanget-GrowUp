        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content p-5 text-center">
                    ...
                    <p>Workshop mu akan diproses maksimal 3 x 24 jam oleh tim GrowUp! Tunggu email konfirmasinya:)</p>
                    <button type="button" class="btn my-3" style="background-color: #FEB139;" data-bs-dismiss="modal">OK</button>
                </div>
            </div>
        </div>
        <h4 class="title">
